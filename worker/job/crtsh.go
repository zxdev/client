...
// }
//
// Note: The certs array is sorted by logged_at descending (most recent first).
// This means certs[0] represents the most recently logged certificate in CT logs,
// which is useful for analytics, ML, and understanding current certificate behavior.
//
